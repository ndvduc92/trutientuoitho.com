...
<div class="account-section quest" id="transactions-container">
    <div class="account-section-title">
        <i class="fas fa-gift"></i> Danh sách Nhiệm Vụ
    </div>
    <table id="killers-table" style="">
        <thead>
            <tr>
                <th class="py-3 px-6 text-left">Tên Nhiệm Vụ</th>
                {{-- <th class="py-3 px-6 text-left">Vật phẩm</th> --}}
                <th class="py-3 px-6 text-left">Xu event</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                @else
                <a href="/nhiem-vu/{{ $item["id"] }}/using" class="btn btn-primary">
    ...
    <div class="security-tips">
        <ul style="width: 100%;">
            <p>🔹 Làm Nhiệm Vụ cho nhân vật <strong style="color:red" class="blink-zoom">{{
