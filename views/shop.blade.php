    ...
    <div class="item-preview">
        ...
        <div id="item-details" class="item-details">
            ...
            <div class="item-image">
                <img id="item-image-display" src="" alt="Item">
            </div>
            ...
            <form action="" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn mua vật phẩm này không?')">
                ...
                <div class="quantity-selector">
                    <label class="quantity-label" for="quantity">Tổng giá tiền: <span id="total"></span></label>
...
<script>
    ...
    function handleQuantityChange(event) {
        ...
        document.getElementById('total').textContent = currentQuantity * currentItem.pointPrice + " xu";
    }
    ...
    function updateItemPreview() {
        ...
        document.getElementById('total').textContent = currentItem.pointPrice + " xu";
