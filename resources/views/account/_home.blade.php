...
<div class="main-content">
  ...
  <div class="stash-filters">
    <div class="filter-tabs">
      <a href="?source=all" class="filter-tab {{ $source == 'all' ? 'active' : '' }}">
        Tất cả </a>
      <a href="?source=boss" class="filter-tab {{ $source == 'boss' ? 'active' : '' }}">
        Boss </a>
      <a href="?source=pk" class="filter-tab {{ $source == 'pk' ? 'active' : '' }}">
        PK </a>
    </div>
  </div>
  ...
  <div class="account-section">
    <div class="account-section-title">
      <i class="fas fa-history"></i> Hoạt động máy chủ
    </div>
    @foreach ($loggings as $item)
    <div class="account-detail">
      <p>
        @if($item["category"] == "boss")
        <span style='color: red'>[Boss]</span>
        @elseif($item["category"] == "pk_boss")
        <span style='color: red'>[PK]</span>
        @elseif($item["category"] == "pk_war")
