...
<div class="main-content">
  ...
  <div class="stash-filters">
    <div class="filter-tabs">
      <a href="?type=date" class="filter-tab {{ $type == 'date' ? 'active' : '' }}">
  ...
  <div class="account-section">
    <div class="account-section-title">
      <img style="max-height: 30px; max-width: fit-content; height: auto; width: auto;"
        src="https://tutiengioi.online/images/badge/other/thien_de_kinh.gif" alt=""> Bảng xếp hạng (<span
        style="color:red"><a target="_blank" href="/war-live">Xem trực quan</a></span>)
    </div>
    <div id="killers" class="tab-content active">
      ...
      <table id="killers-table">
        ...
        <tbody>
          ...
          <tr>
            <td class="player-name"><span data-toggle="tooltip" data-placement="top"
