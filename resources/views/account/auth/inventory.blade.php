...
<div class="account-section">
    ...
    <div class="security-tips">
        ...
        <ul style="width: 100%;">
            <li> Túi đồ nhận được từ những nhiệm vụ trên web sẽ được lưu trữ tại đây</li>
            <li> Click chuột vào vật phẩm để gởi vào game</li>
            <li> ⚠️ Phải xóa hết thư cũ trong NPC Tín Sứ, bắt buộc phải làm trống thư để nhận được vật phẩm!</li>
        </ul>
    </div>
    <div style="margin-top:50px">
        ...
        <div class="bag-grid">
            ...
            <div stack="{{$item->stack}}" itemid="{{$item->id}}" class="item bag-slot vip-glow quality-legendary"
        ...
        <form action="" method="POST" hidden id="purchase-form">
            @csrf
            <div class="quantity-selector">
                <label class="quantity-label" for="quantity">Số lượng: <span id="quantity"></span></label>
                <input type="hidden" id="shop_id" name="shop_id" value="">
            </div>

            <!-- Purchase Button -->
            <button class="btn-primary btn" type="submit" style="">
                <i class="fas fa-shopping-cart"></i> Chuyển vào game
            </button>
        </form>
