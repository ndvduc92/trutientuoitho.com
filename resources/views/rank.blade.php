...
@php
$type = request('type', 'war');
@endphp
<div class="main-content">
  <!-- Filters and view toggle -->
  <div class="stash-filters">
    <div class="filter-tabs">
      <a href="?type=war" class="filter-tab {{ $type == 'war' ? 'active' : '' }}">
        Bang chiến </a>
  ...
  <div class="account-section">
    <div class="account-section-title">
      <img style="max-height: 30px; max-width: fit-content; height: auto; width: auto;"
        src="https://tutiengioi.online/images/badge/other/thien_de_kinh.gif" alt=""> Bảng xếp hạng
    </div>
    <div id="killers" class="tab-content active">
      ...
      <table id="killers-table">
        ...
        <tbody>
          ...
          <tr>
            <td class="player-name"><span data-toggle="tooltip" data-placement="top" title="{{ $item->class_name }}">{!!
                $item->class_icon !!}</span> {{$item->name}}</td>
            <td class="rank-column top-rank">{{ $item->class_name }}</td>
            <td>{{ $item->kill }}</td>
            <td>{{ $item->be_killed }}</td>
            <td>{{ $item->kill - $item->be_killed }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
      ...
      <table id="killers-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="rank-column top-rank">{{ $item->class_name }}</td>
            <td>{{ $item->war_kill }}</td>
            <td>{{ $item->war_be_killed }}</td>
            <td>{{ $item->war_kill - $item->war_be_killed }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="player-name"><span data-toggle="tooltip" data-placement="top" title="{{ $item->class_name }}">{!!
                $item->class_icon !!}</span> {{$item->name}}</td>
            <td class="rank-column top-rank">{{ $item->class_name }}</td>
            <td>{{intdiv($item->time_used, 3600)}}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
