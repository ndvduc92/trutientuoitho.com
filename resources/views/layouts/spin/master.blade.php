...
<head>
  ...
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/summernote/summernote-bs4.min.css">
  <!-- DataTable -->
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/select2/css/select2.min.css">
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <!-- Toastr -->
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/toastr/toastr.min.css">
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/plugins/jquery-ui/jquery-ui.min.css">

  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/dist/flags/css/flag-icon.min.css">
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/dist/css/style.css">
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/dist/css/backend.css">
  <link rel="stylesheet" href="/spin/AdminLTE-3.1.0/dist/css/countrySelect.css">
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/spin/AdminLTE-3.1.0/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>

  <!-- Navbar -->
  @include('layouts.spin.header')
  <!-- /.navbar -->

  <!-- Main Sidebar Container -->
  @include('layouts.spin.sidebar')
...
<!-- jQuery UI 1.11.4 -->
<script src="/spin/AdminLTE-3.1.0/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Select2 -->
<script src="/spin/AdminLTE-3.1.0/plugins/select2/js/select2.full.min.js"></script>
<!-- SweetAlert2 -->
<script src="/spin/AdminLTE-3.1.0/plugins/sweetalert2/sweetalert2.min.js"></script>
<!-- Toastr -->
<script src="/spin/AdminLTE-3.1.0/plugins/toastr/toastr.min.js"></script>
<!-- jquery-validation -->
<script src="/spin/AdminLTE-3.1.0/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="/spin/AdminLTE-3.1.0/plugins/jquery-validation/additional-methods.min.js"></script>
<!-- File Input -->
{{-- <script src="/spin/js/fileinput.min.js"></script> --}}
<!-- Tempusdominus Bootstrap 4 -->
<script src="/spin/AdminLTE-3.1.0/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="/spin/AdminLTE-3.1.0/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="/spin/AdminLTE-3.1.0/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="/spin/AdminLTE-3.1.0/dist/js/adminlte.js"></script>
@yield('script')
</body>
</html>
