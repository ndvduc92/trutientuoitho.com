...
<div class="rewards_popup" style="display: none;">
    <div class="popup_bg">
        ...
        <div class="rewards_txt t1">
            <h4>Giftcode Tân Thủ</h4>
            <div>
                Khách đến nhà, có quà giftcode. Món quà nhỏ hỗ trợ Tân Thủ trên con đường hành tẩu tại Tru Tiên Hỗn
                Thế. Vui lòng nhận tại trang web id.trutienhonthe.com, mục Giftcode sau đó kiểm tra tín sứ.
            </div>
        </div>
        ...
        <div class="rewards_txt t3">
            <h4>Quà Event</h4>
            <div>
                Các sự kiện lớn/nhỏ được tổ chức xuyên suốt cùng những phần thưởng hấp dẫn theo từng mốc giai đoạn.
            </div>
        </div>
