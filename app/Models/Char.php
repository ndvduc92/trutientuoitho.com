...
class Char extends Model
{
    ...
    protected $appends = ['class_name', 'class_icon', 'image', 'map'];
    ...
    public const CLASSES = [
        ...
        [
            ...
            "img"   => "/static/role-chenhuang.png",
            "name"  => "Thần Hoàng",
            "icon"  => "-1200px",
        ],
        [
            "class" => "51,52,53,54,55",
            "img"   => "/static/role-tianhua.png",
            "name"  => "Thiên Hoa",
            "icon"  => "-1100px",
        ],
        [
            "class" => "33,34,35,36,37",
            "img"   => "/static/role-jiuli.png",
            "name"  => "Cửu Lê",
            "icon"  => "-740px",
        ],
        [
            "class" => "96,97,98,99,100",
            "img"   => "/static/role-taihao.png",
            "name"  => "Thái Hạo",
            "icon"  => "-980px",
        ],
        [
            "class" => "45,46,47,48,49",
            "img"   => "/static/role-huaiguang.png",
            "name"  => "Hoài Quang",
            "icon"  => "-2000px",
        ],
        [
            "class" => "39,40,41,42,43",
            "img"   => "/static/role-lieshan.png",
            "name"  => "Liệt Sơn",
            "icon"  => "-860px",
        ],
        [
            "class" => "64,65,66,67,68",
            "img"   => "/static/role-fenxiang.png",
            "name"  => "Phần Hương Cốc",
            "icon"  => "-1360px",
        ],
        [
            "class" => "7,8,9,19,20",
            "img"   => "/static/role-qingyun.png",
            "name"  => "Thanh Vân Môn",
            "icon"  => "-400px",
        ],
        [
            "class" => "10,11,12,22,23",
            "img"   => "/static/role-tianyin.png",
            "name"  => "Thiên Âm Tự",
            "icon"  => "-460px",
        ],
        [
            "class" => "4,5,6,16,17",
            "img"   => "/static/role-hehuan.png",
            "name"  => "Hợp Hoan Phái",
            "icon"  => "-340px",
        ],
        [
            "class" => "1,2,3,13,14",
            "img"   => "/static/role-guiwang.png",
            "name"  => "Quỷ Vương Tông",
            "icon"  => "-280px",
        ],
        [
            "class" => "26,27,28,29",
            "img"   => "/static/role-guidao.png",
            "name"  => "Quỷ Đạo",
            "icon"  => "-580px",
        ],
    ];
    ...
    {
        $map = collect(self::MAPS)->first(function ($value, int $key) {
            return $this->worldtag == $key;
        });
        return $map ? $map : "Không xác định";
    }
    ...
    {
        return Logging::where("char_id", $this->char_id)->where("type", "boss")->count();
    }

    public function bosses()
    {
        return $this->hasMany(Logging::class, 'char_id', 'char_id')->where('type', 'boss');
    }
    ...
    public function getImageAttribute()
    {
        ...
        return $item ? $item["img"] : "Chưa cập nhật";
    }
}
