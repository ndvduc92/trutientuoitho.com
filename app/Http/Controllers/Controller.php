...
class Controller extends BaseController
{
    ...
    public function refresh($types = [])
    {
        ...
        if (in_array("char", $types)) {
            $gameApi  = "https://id.trutienvietnam.com/api/chars";
        ...
        if (in_array("boss", $types)) {
            $gameApi  = "https://id.trutienvietnam.com/api/boss";
            $response = $client->request("GET", $gameApi, [
                "headers" => [
                    "Accept" => "application/json",
                ],
        ...
        if (in_array("pk_boss", $types)) {
            $gameApi  = "https://id.trutienvietnam.com/api/war";
            $response = $client->request("GET", $gameApi, [
                "headers" => [
                    "Accept" => "application/json",
                ],
